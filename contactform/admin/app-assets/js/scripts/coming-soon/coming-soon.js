...
$(document).ready(function() {
    ...
    $('#clockImage').countdown('2020/8/10').on('update.countdown', function(event) {
    ...
    $('#clockFlat').countdown('2020/8/10').on('update.countdown', function(event) {
      var $this = $(this).html(event.strftime(''
    ...
    $('#clockMinimal').countdown('2020/8/10').on('update.countdown', function(event) {
      var $this = $(this).html(event.strftime(''
